...
export function getMovies(page: number = 1,
    ...
    const url = 'http://marios.com.gr/movies/api/?status=13&userid=' + useId + '&page=' + page + '&when=' + when + '&what=' + what + '&cat=' + cat + '&adult=' + adult + '&token=' + token;
...
export function getMatchedMovies(uid: string, fid: number){
    ...
    const token = getToken();
    const url = 'http://marios.com.gr/movies/api/?status=11&fid=' + fid + '&uid=' + uid + '&token=' + token;
...
export function saveUser(uid: string, email: string, check: boolean = false){
    ...
    const url = 'http://marios.com.gr/movies/api/?status=' + status + '&email=' + email + '&uid=' + uid + '&token=' + token;
...
export function getUser(uid: string, email: string){
    ...
    const token = getToken();
    const url = 'http://marios.com.gr/movies/api/?status=4&uid=' + uid + '&email=' + email + '&token=' + token;
...
export function updateUsersMovies(uid: string, mid: number, mstatus: number){
    ...
    const token = getToken();
    const url = 'http://marios.com.gr/movies/api/?status=3&uid=' + uid + '&mid=' + mid + '&mstatus=' + mstatus + '&token=' + token;
...
export function getMenuCounts(uid: string){
    const token = getToken();
    const url = 'http://marios.com.gr/movies/api/?status=5&uid=' + uid + '&token=' + token;
...
export function searchFriend(uid: string, q: string){
    ...
    const token = getToken();
    const url = 'http://marios.com.gr/movies/api/?status=6&q=' + q + '&uid=' + uid + '&token=' + token;
    //console.log('save user', url);
    return fetch(url)
        .then(res => res.json())
        .then((result) => {
...
export function addFriend(uid: string, fid: number){
    ...
    const token = getToken();
    const url = 'http://marios.com.gr/movies/api/?status=7&fid=' + fid + '&uid=' + uid + '&token=' + token;
...
export function deleteFriend(uid: string, fid: number){
    ...
    const token = getToken();
    const url = 'http://marios.com.gr/movies/api/?status=12&fid=' + fid + '&uid=' + uid + '&token=' + token;
    //console.log('add friend', url);
    return fetch(url)
        .then(res => res.json())
        .then((result) => {
...
export function getFriends(uid: string, fstatus: number){
    ...
    const token = getToken();
    const url = 'http://marios.com.gr/movies/api/?status=8&fstatus=' + fstatus + '&uid=' + uid + '&token=' + token;
...
export function getFriendById(uid: number){
    ...
    const token = getToken();
    const url = 'http://marios.com.gr/movies/api/?status=9&uid=' + uid + '&token=' + token;
...
export function acceptFriendRequest(fid:number, status:boolean){
    const token = getToken();
    const url = 'http://marios.com.gr/movies/api/?status=10&fid=' + fid + '&reqstatus=' + status + '&token=' + token;
...
export function seenThisMovie(uid:string, mid:number, status:number){
    const token = getToken();
    const url = 'http://marios.com.gr/movies/api/?status=15&uid=' + uid + '&mid='+ mid + '&mstatus='+ status + '&token=' + token;
    //console.log('accept friend request', url);
    return fetch(url)
        .then(res => res.json())
        .then((result) => {
...
export function suggestMovieToFriend(uid:string, mid:number, fid:number){
    const token = getToken();
    const url = 'http://marios.com.gr/movies/api/?status=16&uid=' + uid + '&mid='+ mid + '&fid='+ fid + '&token=' + token;
